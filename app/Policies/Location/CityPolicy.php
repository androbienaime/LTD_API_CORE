...
class CityPolicy
{
     ...
     */
    public function view(Account $account, City $city): bool
    {
     ...
     */
    public function update(Account $account, City $city): bool
    {
     ...
     */
    public function delete(Account $account, City $city): bool
    {
     ...
     */
    public function forceDelete(Account $account, City $city): bool
    {
     ...
     */
    public function restore(Account $account, City $city): bool
    {
     ...
     */
    public function replicate(Account $account, City $city): bool
    {
