...
class CountryPolicy
{
     ...
     */
    public function view(Account $account, Country $country): bool
    {
     ...
     */
    public function update(Account $account, Country $country): bool
    {
     ...
     */
    public function delete(Account $account, Country $country): bool
    {
     ...
     */
    public function forceDelete(Account $account, Country $country): bool
    {
     ...
     */
    public function restore(Account $account, Country $country): bool
    {
     ...
     */
    public function replicate(Account $account, Country $country): bool
    {
