...
class StatePolicy
{
    ...
    {
        return $account->can('view_any_core::location::state');
    }

    /**
     * Determine whether the account can view the model.
     */
    public function view(Account|User $account, State $state): bool
    {
        return $account->can('view_core::location::state');
    }
    ...
    {
        return $account->can('create_core::location::state');
    }

    /**
     * Determine whether the account can update the model.
     */
    public function update(Account|User $account, State $state): bool
    {
        return $account->can('update_core::location::state');
    }

    /**
     * Determine whether the account can delete the model.
     */
    public function delete(Account|User $account, State $state): bool
    {
        return $account->can('delete_core::location::state');
    }
    ...
    {
        return $account->can('delete_any_core::location::state');
    }

    /**
     * Determine whether the account can permanently delete.
     */
    public function forceDelete(Account|User $account, State $state): bool
    {
        return $account->can('force_delete_core::location::state');
    }
    ...
    {
        return $account->can('force_delete_any_core::location::state');
    }

    /**
     * Determine whether the account can restore.
     */
    public function restore(Account|User $account, State $state): bool
    {
        return $account->can('restore_core::location::state');
    }
    ...
    {
        return $account->can('restore_any_core::location::state');
    }

    /**
     * Determine whether the account can replicate.
     */
    public function replicate(Account|User $account, State $state): bool
    {
        return $account->can('replicate_core::location::state');
    }
    ...
    {
        return $account->can('reorder_core::location::state');
    }
}
