...
class CustomerPolicy
{
     ...
     */
    public function forceDelete(Account $account, Customer $customer): bool
    {
     ...
     */
    public function restore(Account $account, Customer $customer): bool
    {
     ...
     */
    public function replicate(Account $account, Customer $customer): bool
    {
