...
class BrandPolicy
{
     ...
     */
    public function forceDelete(Account $account, Brand $brand): bool
    {
     ...
     */
    public function restore(Account $account, Brand $brand): bool
    {
     ...
     */
    public function replicate(Account $account, Brand $brand): bool
    {
