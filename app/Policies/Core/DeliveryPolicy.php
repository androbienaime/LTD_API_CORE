...
class DeliveryPolicy
{
     ...
     */
    public function view(Account|User $account, Delivery $delivery): bool
    {
     ...
     */
    public function update(Account|User $account, Delivery $delivery): bool
    {
     ...
     */
    public function delete(Account|User $account, Delivery $delivery): bool
    {
     ...
     */
    public function forceDelete(Account|User $account, Delivery $delivery): bool
    {
     ...
     */
    public function restore(Account|User $account, Delivery $delivery): bool
    {
     ...
     */
    public function replicate(Account|User $account, Delivery $delivery): bool
    {
