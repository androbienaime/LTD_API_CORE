...
class CurrencyPolicy
{
     ...
     */
    public function view(Account|User $account, Currency $currency): bool
    {
     ...
     */
    public function update(Account|User $account, Currency $currency): bool
    {
     ...
     */
    public function delete(Account|User $account, Currency $currency): bool
    {
     ...
     */
    public function forceDelete(Account|User $account, Currency $currency): bool
    {
     ...
     */
    public function restore(Account|User $account, Currency $currency): bool
    {
     ...
     */
    public function replicate(Account|User $account, Currency $currency): bool
    {
