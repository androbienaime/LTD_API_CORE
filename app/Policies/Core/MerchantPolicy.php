...
class MerchantPolicy
{
    ...
    {
        return $account->can('view_any_core::merchant');
    }

    /**
     * Determine whether the account can view the model.
     */
    public function view(Account|User $account, Merchant $merchant): bool
    {
        return $account->can('view_core::merchant');
    }
    ...
    {
        return $account->can('create_core::merchant');
    }

    /**
     * Determine whether the account can update the model.
     */
    public function update(Account|User $account, Merchant $merchant): bool
    {
        return $account->can('update_core::merchant');
    }

    /**
     * Determine whether the account can delete the model.
     */
    public function delete(Account|User $account, Merchant $merchant): bool
    {
        return $account->can('delete_core::merchant');
    }
    ...
    {
        return $account->can('delete_any_core::merchant');
    }

    /**
     * Determine whether the account can permanently delete.
     */
    public function forceDelete(Account|User $account, Merchant $merchant): bool
    {
        return $account->can('force_delete_core::merchant');
    }
    ...
    {
        return $account->can('force_delete_any_core::merchant');
    }

    /**
     * Determine whether the account can restore.
     */
    public function restore(Account|User $account, Merchant $merchant): bool
    {
        return $account->can('restore_core::merchant');
    }
    ...
    {
        return $account->can('restore_any_core::merchant');
    }

    /**
     * Determine whether the account can replicate.
     */
    public function replicate(Account|User $account, Merchant $merchant): bool
    {
        return $account->can('replicate_core::merchant');
    }
    ...
    {
        return $account->can('reorder_core::merchant');
    }
}
