...
class ProductPolicy
{
     ...
     */
    public function view(Account|User $account, Product $product): bool
    {
     ...
     */
    public function delete(Account|User $account, Product $product): bool
    {
     ...
     */
    public function forceDelete(Account|User $account, Product $product): bool
    {
     ...
     */
    public function restore(Account|User $account, Product $product): bool
    {
     ...
     */
    public function replicate(Account|User $account, Product $product): bool
    {
