...
class OrderPolicy
{
    ...
    {
        return $account->can('view_any_core::order');
    }

    /**
     * Determine whether the account can view the model.
     */
    public function view(Account|User $account, Order $order): bool
    {
        return $account->can('view_core::order');
    }
    ...
    {
        return $account->can('create_core::order');
    }

    /**
     * Determine whether the account can update the model.
     */
    public function update(Account|User $account, Order $order): bool
    {
        return $account->can('update_core::order');
    }
...
//        return $account->can('force_delete_any_core::order');
     ...
     */
    public function restore(Account|User $account, Order $order): bool
    {
        return $account->can('restore_core::order');
    }
    ...
    {
        return $account->can('restore_any_core::order');
    }

    /**
     * Determine whether the account can replicate.
     */
    public function replicate(Account|User $account, Order $order): bool
    {
        return $account->can('replicate_core::order');
    }
    ...
    {
        return $account->can('reorder_core::order');
    }
}
