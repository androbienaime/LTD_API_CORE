...
class CarrierPolicy
{
     ...
     */
    public function view(Account $account, Carrier $carrier): bool
    {
     ...
     */
    public function update(Account $account, Carrier $carrier): bool
    {
     ...
     */
    public function delete(Account $account, Carrier $carrier): bool
    {
     ...
     */
    public function forceDelete(Account $account, Carrier $carrier): bool
    {
     ...
     */
    public function restore(Account $account, Carrier $carrier): bool
    {
     ...
     */
    public function replicate(Account $account, Carrier $carrier): bool
    {
