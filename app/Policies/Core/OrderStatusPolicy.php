...
class OrderStatusPolicy
{
     ...
     */
    public function view(Account $account, OrderStatus $orderStatus): bool
    {
     ...
     */
    public function update(Account $account, OrderStatus $orderStatus): bool
    {
     ...
     */
    public function delete(Account $account, OrderStatus $orderStatus): bool
    {
     ...
     */
    public function forceDelete(Account $account, OrderStatus $orderStatus): bool
    {
     ...
     */
    public function restore(Account $account, OrderStatus $orderStatus): bool
    {
     ...
     */
    public function replicate(Account $account, OrderStatus $orderStatus): bool
    {
