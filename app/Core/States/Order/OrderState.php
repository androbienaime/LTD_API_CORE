...
abstract class OrderState extends State
{
    ...
    public static function config() : StateConfig
    {
        return parent::config()
            ...
            ->allowTransition(PendingState::class, ProcessingState::class)
            ->allowTransition(PendingState::class, ShippedState::class)
            ->allowTransition(ProcessingState::class, ShippedState::class)
            ->allowTransition(PendingState::class, DeliveredState::class)
            ->allowTransition(ProcessingState::class, DeliveredState::class)
